...
def main():
    ...
    # 💡 修改: 调用 get_efficientnet_b0
    model_s1 = model_loader.get_efficientnet_b0(stage=1)
    ...
    print("\n在测试集上评估第一阶段的最佳模型...")
    # 💡 修改: 确保加载权重前使用正确的模型结构
    model_to_test_s1 = model_loader.get_efficientnet_b0(stage=1)
    ...
    # 💡 修改: 调用 get_efficientnet_b0
    model_s2 = model_loader.get_efficientnet_b0(stage=2)
    ...
    print("\n在测试集上评估第二阶段的最佳模型...")
    # 💡 修改: 确保加载权重前使用正确的模型结构
    model_to_test_s2 = model_loader.get_efficientnet_b0(stage=2)
